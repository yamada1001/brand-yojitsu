        ...
        >
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300">大分県</p>
            </div>
            <div>
              <h4 className="text-sm font-semibold uppercase tracking-wider mb-3 text-gray-400">
                連絡先
              ...
              <p className="text-gray-300 mb-2">
                <a href="tel:080-4692-9681" className="hover:text-white transition-colors">
                  080-4692-9681
                </a>
              </p>
              <p className="text-gray-300">
                <a href="mailto:yamada@yojitu.com" className="hover:text-white transition-colors">
                  yamada@yojitu.com
                </a>
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-gray-400">定休日なし</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-center md:text-left">
              <div className="text-2xl font-bold mb-2">余日</div>
